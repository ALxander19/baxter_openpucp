...
if __name__ == '__main__':
  ...
  personnear = 'notdetected'
  state = 1
  pub_life.publish("notalive")
  rospy.sleep(1)
  pub_life.publish("alive")

  rospy.loginfo("The program start to run")

  while not rospy.is_shutdown():
    
    if(last_button_state == 'pushed' and button_state == 'notpushed' and state == 1):
      rospy.loginfo("Boton levantado")
      map_file("/home/alex/tryout_ws/src/baxter_openpucp/init_hugh",1)
      rospy.sleep(1)
      state = 2

    elif(last_button_state == 'notpushed' and button_state == 'notpushed' and personnear == 'detected' and state == 2):
      rospy.loginfo("Persona cerca")
    ...
    elif(last_button_state == 'notpushed' and button_state == 'pushed' and state == 1):
      rospy.loginfo("Boton presionado")
      pub_life.publish("notalive")
